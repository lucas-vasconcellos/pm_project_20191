...
public class DomServiceTest {
	/**
	 * Teste do método que fera um Document a partir de um File no caso de
	 * sucesso
	 * 
	...
	/**
	 * Teste que faz a verificação da quantidade de nós de municípios retornados
	 * de um arquivo .kml
	 * 
	 * @throws ParserConfigurationException
	 * @throws SAXException
	...
	/**
	 * Teste na falha da verificação da quantidade de nós de municípios
	 * retornados de um arquivo .kml
	 * 
	 * @throws ParserConfigurationException
	 * @throws SAXException
	 * @throws IOException
